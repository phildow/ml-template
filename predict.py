...
def generate_arg_parser():
  ...
  parser.add_argument(
    '--model-dir',
    type=str,
    help='The model directory where training model outputs reside'
  )
  ...
  parser.add_argument(
    '--batch',
    type=int,
    help='The batch size to predict. Pass in 1 if you are predicting on an input other than a tf record',
    required=True
  )
